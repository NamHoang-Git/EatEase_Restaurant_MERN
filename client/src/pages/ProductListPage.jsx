...
const ProductListPage = () => {
    ...
    return (
        <section className="sticky top-24 lg:top-20 bg-gray-50 min-h-screen">
            <div className="container mx-auto grid grid-cols-1 lg:grid-cols-[280px,1fr] gap-4 p-2 md:p-4">
                {/** Category Sidebar **/}
                <div className="bg-white rounded-lg shadow-sm p-4 h-fit sticky top-24">
                    ...
                    <div className="space-y-2 max-h-[calc(100vh-180px)] overflow-y-auto pr-2">
                        {displayCategory.map((s) => {
                            const link = `/${valideURLConvert(s.name)}-${
                                s._id
                            }`;
                            return (
                                <Link
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className="appearance-none bg-white border border-gray-300 rounded-lg px-3 py-2 pr-8 text-sm focus:outline-none focus:ring-2 focus:ring-rose-500 focus:border-transparent"
                                    >
